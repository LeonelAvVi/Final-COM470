...
public class CoffeeMakerTest {
	...
	public void testdeleteRecipe() throws InventoryException {
		String result=coffeeMaker.deleteRecipe(4);
	...
	public void testAddInventory() throws InventoryException {
        ...
        @Test
	public void testEditRecipe() throws InventoryException {
                Recipe nuevo = new Recipe();
                String result = coffeeMaker.editRecipe(4, nuevo);
                assertEquals(null, result);
	}
	...
	public void testMakeCoffee(){
                ...
                assertEquals(75, coffeeMaker.makeCoffee(-10,75));
